   ...
   if request.method == 'POST':       
       ...
       if form.is_valid():                                
          ...
          #then use pre-defined Django function to login
               login(request, user)                
               return redirect('recipes:recipes_home') #& send the user to desired page
...
def logout_view(request):                                  
   ...
   return redirect('recipes:recipes_home')    #after logging out go to login form (or whichever page you want)
